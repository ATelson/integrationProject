...
public class Main {
  public static void main(String[] args) throws Exception {
    ...
    FishingRod rodOne = new FishingRod("Ole Yeller"); // name of the rod
    rodOne.getDurability(2); // the durability of the rod
    rodOne.getPwr(1); // the power of the rod
    rodOne.getColor("Moonshine-y Gray"); // the color of the rod
    System.out.println("\t");
    ...
    nbaStats.put("James Harden", new Double(stat + 0.19));
 
    stat = ((Double) nbaStats.get("Anthony Davis")).doubleValue();
    nbaStats.put("Anthony Davis", new Double(stat + 0.33));
    
    stat = ((Double) nbaStats.get("LeBron James")).doubleValue();
    nbaStats.put("LeBron James", new Double(stat + 0.33));
    
    stat = ((Double) nbaStats.get("Damian Lillard")).doubleValue();
    nbaStats.put("Damian Lillard", new Double(stat + 0.33));
    
    stat = ((Double) nbaStats.get("Giannis Antetokounmpo")).doubleValue();
    nbaStats.put("Giannis Antetokounmpo", new Double(stat + 0.33));
    
    stat = ((Double) nbaStats.get("Kevin Durant")).doubleValue();
    nbaStats.put("Kevin Durant", new Double(stat + 0.33));
   
    stat = ((Double) nbaStats.get("Russell Westbrook")).doubleValue();
    nbaStats.put("Russell Westbrook", new Double(stat + 0.33));
    
    stat = ((Double) nbaStats.get("LaMarcus Aldridge")).doubleValue();
    nbaStats.put("LaMarcus Aldridge", new Double(stat + 0.33));
    
    stat = ((Double) nbaStats.get("Victor Oladipo")).doubleValue();
    nbaStats.put("Victor OladiVictor Oladipopo", new Double(stat + 0.33));
